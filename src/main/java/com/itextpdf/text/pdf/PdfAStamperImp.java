/*
 * Customização da versão 5.5.4 da API que ignora a verificação, dada pelo método, readPdfAInfo()
 * do compliance com PDF/A ao abrir o PDF. Sem isso, não era possível abrir um documento
 * NÃO PDF/A para convertê-lo para PDF/A.   
 */
